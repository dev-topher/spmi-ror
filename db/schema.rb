...
ActiveRecord::Schema[7.0].define(version: 2023_09_22_002010) do
  ...
  create_table "colleges", force: :cascade do |t|
    t.string "name", null: false
    t.boolean "status_college", default: true, null: false
    t.bigint "country_id"
  ...
  create_table "detail_colleges", force: :cascade do |t|
    t.bigint "college_id"
    t.bigint "program_id"
    t.index ["college_id"], name: "index_detail_colleges_on_college_id"
    t.index ["program_id"], name: "index_detail_colleges_on_program_id"
  end

  create_table "detail_programs", force: :cascade do |t|
    t.bigint "program_id"
    t.bigint "announcement_id"
    t.index ["announcement_id"], name: "index_detail_programs_on_announcement_id"
  ...
  create_table "programs", force: :cascade do |t|
    ...
    t.integer "status_program", default: 1, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "detail_colleges", "colleges"
  add_foreign_key "detail_colleges", "programs"
  add_foreign_key "detail_programs", "announcements"
